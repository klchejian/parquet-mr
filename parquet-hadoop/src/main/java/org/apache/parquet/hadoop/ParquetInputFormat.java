...
public class ParquetInputFormat<T> extends FileInputFormat<Void, T> {
  ...
  /**
   * key to configure whether row group index filtering is enabled
   */
  public static final String INDEX_FILTERING_ENABLED = "parquet.filter.index.enabled";
  static final boolean INDEX_FILTERING_ENABLED_DEFAULT = false;
