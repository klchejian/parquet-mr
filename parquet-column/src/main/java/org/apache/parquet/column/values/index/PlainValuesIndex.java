 ...
 *
 */
public abstract class PlainValuesIndex extends Index {
...
//   */
//  public static class PlainBinaryDictionary extends PlainValuesIndex {
//
...
//   */
//  public static class PlainLongDictionary extends PlainValuesIndex {
//
...
//   */
//  public static class PlainDoubleDictionary extends PlainValuesIndex {
//
...
//
   ...
   */
  public static class PlainIntegerDictionary extends PlainValuesIndex {

    private int[] intIndexContent = null;

    /**
     * @param indexPage
     * @throws IOException
     */
    public PlainIntegerDictionary(IndexPage indexPage) throws IOException {
      super(indexPage);
      final ByteBuffer indexByteBuf = indexPage.getBytes().toByteBuffer();
      intIndexContent = new int[indexPage.getIndexSize()];
      IntegerPlainValuesReader intReader = new IntegerPlainValuesReader();
      intReader.initFromPage(indexPage.getIndexSize(), indexByteBuf, 0);
      for (int i = 0; i < intIndexContent.length; i++) {
        intIndexContent[i] = intReader.readInteger();
      }
    }

    @Override
    public int decodeToInt(int id) {
      return intIndexContent[id];
    }
    ...
    @Override
    public int getMaxId() {
      return intIndexContent.length - 1;
    }
...
//   */
//  public static class PlainFloatDictionary extends PlainValuesIndex {
//
